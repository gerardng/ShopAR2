    ...
    SampleApplicationControl, SampleAppMenuInterface
{
    ...
    public static final int IMAGE_TARGET_1 = 0;
    public static final int IMAGE_TARGET_2 = 1;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mMovieName[IMAGE_TARGET_1] = "VideoPlayback/Movie_Clip_1.mp4";
        mMovieName[IMAGE_TARGET_2] = "VideoPlayback/Movie_Clip_2.mp4";
    ...
    private void loadTextures()
    {
        mTextures.add(Texture.loadTextureFromApk(
                "VideoPlayback/Movie_Post_1.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk(
                "VideoPlayback/Movie_Poster_2.png", getAssets()));
